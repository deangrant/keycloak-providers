...
3. If failures look Keycloak-API related, suggest re-running against another matrix version from CI (`26.7.1`, `26.6.4`, `26.5.7`, `26.4.7`) before changing production code.
